...
export default function USoundActivity() {
  ...
  const items = [
    { name: 'unicorn', color: '#FF9E9E' },
    { name: 'uniform', color: '#FFD6A5' },
    { name: 'unique', color: '#FDFFB6' },
    { name: 'universe', color: '#CAFFBF' },
    { name: 'useful', color: '#9BF6FF' },
    { name: 'human', color: '#A0C4FF' },
    { name: 'music', color: '#BDB2FF' },
    { name: 'cube', color: '#FFC6FF' },
    { name: 'future', color: '#FFADAD' },
    { name: 'mule', color: '#FFD6A5' },
  ];
  ...
  return (
    <ThemedView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <ThemedText style={styles.title}>Long U Sound Treasure Hunt</ThemedText>
