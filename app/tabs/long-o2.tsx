...
const quizData = [
  { word: 'bone', options: ['moon', 'bone', 'bon'] },
  { word: 'home', options: ['home', 'him', 'rome'] },
  { word: 'rope', options: ['rop', 'rope', 'rip'] },
  { word: 'vote', options: ['vote', 'vet', 'vot'] },
  { word: 'note', options: ['nat', 'net', 'note'] },
  { word: 'cone', options: ['can', 'cone', 'cin'] },
  { word: 'joke', options: ['jack', 'jick', 'joke'] },
  { word: 'hope', options: ['hope', 'hip', 'hap'] },
  { word: 'rode', options: ['rad', 'rid', 'rode'] },
  { word: 'code', options: ['cad', 'code', 'cid'] },
];
...
export default function LongOQuiz() {
  ...
  const goToNextActivity = async () => {
    if (quizCompleted) {
      try {
        await saveScore('long', 'o', score, quizData.length, selectedWords);
      } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Find the Long O Word</Text>
