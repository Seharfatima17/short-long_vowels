...
export default function LongOActivityScreen() {
  const router = useRouter();

  const vowelData = {
    letter: 'o',
    //sound: 'oa',
    soundDescription: 'Long O sound (as in bone)',
    examples: ['bone', 'home', 'rope', 'vote', 'stone', 'phone', 'globe'],
    practiceWords: ['cone', 'hope', 'joke', 'note', 'wrote']
  };
  ...
  const playLongOSound = () => {
    speak('o , o , o');
  };

  const navigateToLetterActivityScreen = () => {
    router.push('/tabs/long-o1');
  };
    ...
    <ThemedView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity
          ...
          onPress={playLongOSound}
          disabled={isSpeaking}
        >
          <ThemedText style={styles.buttonText}>
            {isSpeaking ? 'Playing...' : 'Pronunciation of Long O'}
          </ThemedText>
        </TouchableOpacity>
      </View>
