...
const shortEWords = [
  {
    keyword: 'pen',
    image: 'https://png.pngtree.com/png-vector/20240310/ourmid/pngtree-black-and-gold-fountain-pen-png-image_11927367.png',
    options: ['pane', 'pen'],
    correct: 'pen',
  },
  {
  ...
  {
    keyword: 'red',
    image: 'https://png.pngtree.com/png-clipart/20230324/ourmid/pngtree-red-brush-stroke-element-png-image_6666189.png',
    options: ['reed', 'red'],
    correct: 'red',
  },
  {
...
const ShortEActivity = () => {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity style={styles.backArrow} onPress={() => navigation.navigate('short(e)1')}>
